...
('22222222-0000-0000-0000-000000000006','11111111-1111-1111-1111-111111111111','Faux Locs','Realistic faux locs installed with care in your chosen length.','Locs',420,45,22000,50,true,0.08250,'https://picsum.photos/seed/fauxlocs/800/1000','Washed and blow-dried hair.','Keep scalp moisturized. Lasts 6-10 weeks.',6),
('22222222-0000-0000-0000-000000000007','11111111-1111-1111-1111-111111111111','Loc Retwist & Style','Retwist, wash and style for established locs.','Locs',120,15,8500,50,true,0.08250,'https://picsum.photos/seed/locs/800/1000','Come with locs unwrapped.','Retwist every 4-6 weeks.',7),
...
-- Faux locs
('22222222-0000-0000-0000-000000000006','Shoulder / Bob','length',0,0,1),
('22222222-0000-0000-0000-000000000006','Bra length','length',3000,45,2),
('22222222-0000-0000-0000-000000000006','Waist length','length',7000,90,3);
...
('11111111-1111-1111-1111-111111111111','Faux Locs','Shoulder-length faux locs','https://picsum.photos/seed/p5/800/1000','Locs','Shoulder',5),
...
update services set prep_notes =
  ...
  where category in ('Box Braids','Twists','Locs');
